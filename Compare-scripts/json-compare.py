def compare(barnett_slow, barnett_medium, barnett_rapid, fukuda_file, anomaly_fuk, anomaly_bar):
    ...
    with open(f'{anomaly_fuk}.txt', 'a') as file:
        ...
        file.write(f'Total ICMP other uniqe ips in fukuda: {fukuda_ips_count}\n')
...
# TCP comparions
# Port
compare(barnett_oto_slow_tcp, barnett_oto_medium_tcp, barnett_oto_rapid_tcp, fukuda_tcp_port, 'tcp-port', 'one-to-one')
compare(barnett_otm_slow_tcp, barnett_otm_medium_tcp, barnett_otm_rapid_tcp, fukuda_tcp_port, 'tcp-port', 'one-to-many')
compare(barnett_mto_slow_tcp, barnett_mto_medium_tcp, barnett_mto_rapid_tcp, fukuda_tcp_port, 'tcp-port', 'many-to-one')
compare(barnett_mtm_slow_tcp, barnett_mtm_medium_tcp, barnett_mtm_rapid_tcp, fukuda_tcp_port, 'tcp-port', 'many-to-many')

# Network
compare(barnett_oto_slow_tcp, barnett_oto_medium_tcp, barnett_oto_rapid_tcp, fukuda_tcp_network, 'tcp-network', 'one-to-one')
compare(barnett_otm_slow_tcp, barnett_otm_medium_tcp, barnett_otm_rapid_tcp, fukuda_tcp_network, 'tcp-network', 'one-to-many')
compare(barnett_mto_slow_tcp, barnett_mto_medium_tcp, barnett_mto_rapid_tcp, fukuda_tcp_network, 'tcp-network', 'many-to-one')
compare(barnett_mtm_slow_tcp, barnett_mtm_medium_tcp, barnett_mtm_rapid_tcp, fukuda_tcp_network, 'tcp-network', 'many-to-many')

# One flow
compare(barnett_oto_slow_tcp, barnett_oto_medium_tcp, barnett_oto_rapid_tcp, fukuda_tcp_oflow, 'tcp-oflow', 'one-to-one')
compare(barnett_otm_slow_tcp, barnett_otm_medium_tcp, barnett_otm_rapid_tcp, fukuda_tcp_oflow, 'tcp-oflow', 'one-to-many')
compare(barnett_mto_slow_tcp, barnett_mto_medium_tcp, barnett_mto_rapid_tcp, fukuda_tcp_oflow, 'tcp-oflow', 'many-to-one')
compare(barnett_mtm_slow_tcp, barnett_mtm_medium_tcp, barnett_mtm_rapid_tcp, fukuda_tcp_oflow, 'tcp-oflow', 'many-to-many')

# Backscatter
compare(barnett_oto_slow_tcp, barnett_oto_medium_tcp, barnett_oto_rapid_tcp, fukuda_tcp_back, 'tcp-back', 'one-to-one')
compare(barnett_otm_slow_tcp, barnett_otm_medium_tcp, barnett_otm_rapid_tcp, fukuda_tcp_back, 'tcp-back', 'one-to-many')
compare(barnett_mto_slow_tcp, barnett_mto_medium_tcp, barnett_mto_rapid_tcp, fukuda_tcp_back, 'tcp-back', 'many-to-one')
compare(barnett_mtm_slow_tcp, barnett_mtm_medium_tcp, barnett_mtm_rapid_tcp, fukuda_tcp_back, 'tcp-back', 'many-to-many')

# Small
compare(barnett_oto_slow_tcp, barnett_oto_medium_tcp, barnett_oto_rapid_tcp, fukuda_tcp_small, 'tcp-small', 'one-to-one')
compare(barnett_otm_slow_tcp, barnett_otm_medium_tcp, barnett_otm_rapid_tcp, fukuda_tcp_small, 'tcp-small', 'one-to-many')
compare(barnett_mto_slow_tcp, barnett_mto_medium_tcp, barnett_mto_rapid_tcp, fukuda_tcp_small, 'tcp-small', 'many-to-one')
compare(barnett_mtm_slow_tcp, barnett_mtm_medium_tcp, barnett_mtm_rapid_tcp, fukuda_tcp_small, 'tcp-small', 'many-to-many')

# Other
compare(barnett_oto_slow_tcp, barnett_oto_medium_tcp, barnett_oto_rapid_tcp, fukuda_tcp_other, 'tcp-other', 'one-to-one')
compare(barnett_otm_slow_tcp, barnett_otm_medium_tcp, barnett_otm_rapid_tcp, fukuda_tcp_other, 'tcp-other', 'one-to-many')
compare(barnett_mto_slow_tcp, barnett_mto_medium_tcp, barnett_mto_rapid_tcp, fukuda_tcp_other, 'tcp-other', 'many-to-one')
compare(barnett_mtm_slow_tcp, barnett_mtm_medium_tcp, barnett_mtm_rapid_tcp, fukuda_tcp_other, 'tcp-other', 'many-to-many')

# UDP comparisons
# Port
compare(barnett_oto_slow_udp, barnett_oto_medium_udp, barnett_oto_rapid_udp, fukuda_udp_port, 'udp-port', 'one-to-one')
compare(barnett_otm_slow_udp, barnett_otm_medium_udp, barnett_otm_rapid_udp, fukuda_udp_port, 'udp-port', 'one-to-many')
compare(barnett_mto_slow_udp, barnett_mto_medium_udp, barnett_mto_rapid_udp, fukuda_udp_port, 'udp-port', 'many-to-one')
compare(barnett_mtm_slow_udp, barnett_mtm_medium_udp, barnett_mtm_rapid_udp, fukuda_udp_port, 'udp-port', 'many-to-many')

# Network
compare(barnett_oto_slow_udp, barnett_oto_medium_udp, barnett_oto_rapid_udp, fukuda_udp_network, 'udp-network', 'one-to-one')
compare(barnett_otm_slow_udp, barnett_otm_medium_udp, barnett_otm_rapid_udp, fukuda_udp_network, 'udp-network', 'one-to-many')
compare(barnett_mto_slow_udp, barnett_mto_medium_udp, barnett_mto_rapid_udp, fukuda_udp_network, 'udp-network', 'many-to-one')
compare(barnett_mtm_slow_udp, barnett_mtm_medium_udp, barnett_mtm_rapid_udp, fukuda_udp_network, 'udp-network', 'many-to-many')

# One flow
compare(barnett_oto_slow_udp, barnett_oto_medium_udp, barnett_oto_rapid_udp, fukuda_udp_oflow, 'udp-oflow', 'one-to-one')
compare(barnett_otm_slow_udp, barnett_otm_medium_udp, barnett_otm_rapid_udp, fukuda_udp_oflow, 'udp-oflow', 'one-to-many')
compare(barnett_mto_slow_udp, barnett_mto_medium_udp, barnett_mto_rapid_udp, fukuda_udp_oflow, 'udp-oflow', 'many-to-one')
compare(barnett_mtm_slow_udp, barnett_mtm_medium_udp, barnett_mtm_rapid_udp, fukuda_udp_oflow, 'udp-oflow', 'many-to-many')

# Backscatter
compare(barnett_oto_slow_udp, barnett_oto_medium_udp, barnett_oto_rapid_udp, fukuda_udp_back, 'udp-back', 'one-to-one')
compare(barnett_otm_slow_udp, barnett_otm_medium_udp, barnett_otm_rapid_udp, fukuda_udp_back, 'udp-back', 'one-to-many')
compare(barnett_mto_slow_udp, barnett_mto_medium_udp, barnett_mto_rapid_udp, fukuda_udp_back, 'udp-back', 'many-to-one')
compare(barnett_mtm_slow_udp, barnett_mtm_medium_udp, barnett_mtm_rapid_udp, fukuda_udp_back, 'udp-back', 'many-to-many')

# Small
compare(barnett_oto_slow_udp, barnett_oto_medium_udp, barnett_oto_rapid_udp, fukuda_udp_small, 'udp-small', 'one-to-one')
compare(barnett_otm_slow_udp, barnett_otm_medium_udp, barnett_otm_rapid_udp, fukuda_udp_small, 'udp-small', 'one-to-many')
compare(barnett_mto_slow_udp, barnett_mto_medium_udp, barnett_mto_rapid_udp, fukuda_udp_small, 'udp-small', 'many-to-one')
compare(barnett_mtm_slow_udp, barnett_mtm_medium_udp, barnett_mtm_rapid_udp, fukuda_udp_small, 'udp-small', 'many-to-many')

# Other
compare(barnett_oto_slow_udp, barnett_oto_medium_udp, barnett_oto_rapid_udp, fukuda_udp_other, 'udp-other', 'one-to-one')
compare(barnett_otm_slow_udp, barnett_otm_medium_udp, barnett_otm_rapid_udp, fukuda_udp_other, 'udp-other', 'one-to-many')
compare(barnett_mto_slow_udp, barnett_mto_medium_udp, barnett_mto_rapid_udp, fukuda_udp_other, 'udp-other', 'many-to-one')
compare(barnett_mtm_slow_udp, barnett_mtm_medium_udp, barnett_mtm_rapid_udp, fukuda_udp_other, 'udp-other', 'many-to-many')
