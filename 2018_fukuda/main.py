...
from anlysis import tcp_analysis, udp_analysis, icmp_analysis, other_analysis
import time
...
print(f"Other TCP: {len(other_tcp)}") 
print("---------------------")
print("UDP info:")
...
print(f"Other UDP: {len(other_udp)}") 
print("---------------------")
print("ICMP info:")
